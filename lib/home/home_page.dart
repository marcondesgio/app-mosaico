...
class HomePage extends StatelessWidget {
  ...
  Widget _body(BuildContext context) {
    return Column(
      children: [if (user == UserType.adm) _adm(context), if (user == UserType.professional) _professional(context), if (user == UserType.responsible) _responsible(context)],
    );
  }
  ...
  Widget _adm(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _report('Beatriz Cardoso Ferreira', 'assets/professional.jpg'),
        _report('Sophia Costa Melo', 'assets/responsible.jpg'),
        const Padding(
          padding: EdgeInsets.symmetric(horizontal: 24, vertical: 12),
          child: Text(
            'Pacientes',
        ...
        _report('Consulta 10/07/2023', 'assets/professional.jpg'),
        _report('Consulta 05/07/2023', 'assets/responsible.jpg'),
        _report('Consulta 28/06/2023', 'assets/professional.jpg'),
        _report('Consulta 26/06/2023', 'assets/responsible.jpg'),
        const Padding(
          padding: EdgeInsets.symmetric(horizontal: 24, vertical: 12),
          child: Text(
            'Gráficos',
  ...
  Widget _professional(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _report('Consulta 10/07/2023', 'assets/patient.jpg'),
        _report('Consulta 26/06/2023', 'assets/patient.jpg'),
        const Padding(
          padding: EdgeInsets.symmetric(horizontal: 24, vertical: 12),
          child: Text(
            'Gráficos',
  ...
  Widget _responsible(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      _report('Consulta 10/07/2023', 'assets/professional.jpg'),
      _report('Consulta 26/06/2023', 'assets/professional.jpg'),
      const Padding(
        padding: EdgeInsets.symmetric(horizontal: 24, vertical: 12),
        child: Text(
          'Gráficos',
